...
const ReportsAutoSubmissionStatus: React.FC = () => {
  const { autoSubmissionStatus } = useAppSelector((state) => state.dashboard);
  
  const LEGEND = [
    { label: 'Reviewed', value: autoSubmissionStatus.reviewed, color: 'bg-[#0BB783]', text: 'text-white' },
    { label: 'Completed', value: autoSubmissionStatus.completed, color: 'bg-[#FFC107]', text: 'text-[#495057]' },
    { label: 'Pending', value: autoSubmissionStatus.pending, color: 'bg-[#E1505F]', text: 'text-white' },
    { label: 'Alloted', value: autoSubmissionStatus.alloted, color: 'bg-[#3D8BFD]', text: 'text-white' },
  ];
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-5 w-full max-w-sm mx-auto" style={{ minHeight: '200px' }}>
      <h3 className="text-gray-800 font-medium text-lg self-start mb-4">Auto Submission Status</h3>
...
export default ReportsAutoSubmissionStatus;
