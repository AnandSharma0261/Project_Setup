...
const AuditsTable: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-300 shadow-sm w-full mx-auto">
      {/* Header Section - New Custom Filter Design */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 sm:p-4 border-b border-gray-200 bg-gray-50 gap-3 sm:gap-0 relative">
        ...
        {/* Custom Filter Container - Lighter grey background, reduced width */}
        ...
        {/* Center - QLQD_Sales Badge - Bold text, more rounded border */}
        ...
        {/* Right side actions - No background, larger icons */}
